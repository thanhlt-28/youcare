...
<link href="{{asset('assets/css/readmore.css')}}" rel="stylesheet">
...
<link rel="stylesheet" href="{{asset('assets/css/designer.css')}}">
...
<!-- Swiper slider chuyên gia -->
<link href="{{asset('assets/scss/swiper.scss')}}" rel="stylesheet">
