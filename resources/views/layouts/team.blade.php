                                    ...
                                    <div class="slider-92911">
                                        <div class="owl-carousel slide-one-item">
                                            ...
                                            <div class="d-md-flex testimony-29101 align-items-stretch">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="slider__text">
                                                        ...
                                                        <div class="elementor-text-editor elementor-clearfix text-white">
                                                            <p><span style="font-size: 120%;"><strong>Tiến sĩ tâm lý</strong></span></p>
                                            ...
                                            <div class="d-md-flex testimony-29101 align-items-stretch">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="slider__text">
                                                        <h4><a class="text-white" target="_blank" href="{{route('layouts.profile.thmai')}}">TRƯƠNG HOÀNG MAI</a></h4>
