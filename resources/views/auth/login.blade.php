                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pb-2">
                                    ...
                                    <p class="text-center small">Vui lòng nhập email hoặc số điện thoại đăng nhập</p>
                                </div>
                                ...
                                <form role="form" method="POST" action="{{route('auth.postLogin')}}" enctype="multipart/form-data" class="row g-3 needs-validation">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="email" class="form-control" placeholder="Điền email..." id="yourEmail" required>
                                            <div class="invalid-feedback">Điền email...!</div>
                                        </div>
                                    </div>
