                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form role="form" method="POST" action="{{route('auth.store')}}" enctype="multipart/form-data" class="row g-3 needs-validation">
                                    @csrf
                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Họ và tên</label>
                                        <input type="text" name="name" class="form-control" placeholder="Nhập họ & tên..." id="yourName" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="email" name="email" class="form-control" placeholder="Điền email...!" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="password" name="password" class="form-control" placeholder="Nhập mật khẩu..." id="yourPassword" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="password" name="password_confirmation" class="form-control" placeholder="Nhập lại mật khẩu..." id="rePassword" required>
